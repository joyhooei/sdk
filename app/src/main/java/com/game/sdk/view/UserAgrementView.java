...
/**
 * author janecer 2014年7月22日下午6:16:02
 */
public class UserAgrementView extends BaseView {
	...
	public UserAgrementView(Context ctx) {
		acontext = ctx;
		...
		tv_charge_title.setText("用户协议");
		iv_ingame.setVisibility(content_view.GONE);
		...
		wv_content.loadUrl(Constants.URL_USER_AGREMENT);
	}
